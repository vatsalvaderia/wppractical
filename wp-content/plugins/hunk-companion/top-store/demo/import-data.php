...
function top_store_import_files(){
  return apply_filters(
    ...
    array(
        ...
        'preview_url'=> esc_url('https://themehunk.com/wp-themes/topstore/'),
    ...
    array(
        ...
        'preview_url'=> esc_url('https://themehunk.com/wp-themes/topstore-darkscheme/'),
        'import_notice' => __( 'Before importing the demo data, Install & Activate the recommended plugins.', 'top-store' ),
    ),
    array(
        ...
        'preview_url'=> esc_url('https://themehunk.com/wp-themes/topstore-grocery/'),
        'import_notice' => __( 'Before importing the demo data, Install & Activate the recommended plugins.', 'top-store' ),
    ),
