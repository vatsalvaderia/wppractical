...
function open_shop_import_files(){
  return apply_filters(
    ...
    array(
        ...
        'preview_url'=> esc_url('https://themehunk.com/wp-themes/open-shop/'),
    ...
    array(
        ...
        'preview_url'=> esc_url('https://themehunk.com/wp-themes/open-shop-dark/'),
        'import_notice' => __( 'Before importing the demo data, Install & Activate the recommended plugins.', 'open-shop' ),
    ),
    array(
        ...
        'preview_url'=> esc_url('https://themehunk.com/wp-themes/grocery-lite/'),
        'import_notice' => __( 'Before importing the demo data, Install & Activate the recommended plugins.', 'open-shop' ),
    ),
